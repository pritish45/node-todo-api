...
describe('Get /todo/:id',()=>{
  it('should return the required todo doc',(done)=>{
    request(app)
  ...
  it('should return 404 if the required todo is not found',(done)=>{
    request(app)
...
describe('Patch /todos/:id',()=>{
  it('should update the todo',(done)=>{
      ...
      .expect((res)=>{
          ...
          expect(res.body.todos.text).toBe('Test Update');
          expect(res.body.todos.completed).toBe(true);
          expect(res.body.todos.completedAt).toExist();
      })
      .end(done);
  });
